...
void init()
{
  ...
  Rect Car2=Rect(SCREEN_WIDTH-30,SCREEN_HEIGHT*6/10+5,-9,240*c,8*c,240*c,RECT_HEIGHT,RECT_HEIGHT);
  ...
  Rect Log0=Rect(SCREEN_WIDTH-100,SCREEN_HEIGHT*1/10+5,5,204*c,233*c,82*c,3*RECT_HEIGHT,RECT_HEIGHT);
  Rect Log1=Rect(100,SCREEN_HEIGHT*2/10,5,204*c,233*c,82*c,LANE_HEIGHT*2,RECT_HEIGHT);
  Rect Log2=Rect(SCREEN_WIDTH-100,SCREEN_HEIGHT*3/10+5,5,204*c,233*c,82*c,4*RECT_HEIGHT,RECT_HEIGHT);
  Rect Log3=Rect(100,SCREEN_HEIGHT*4/10,5,204*c,233*c,82*c,LANE_HEIGHT*3,RECT_HEIGHT);
